...
$sourceFolder = 'https://datalake1demo.blob.core.chinacloudapi.cn/vhdx'
$sas = "?sp=rl&st=2023-03-25T12:51:15Z&se=2024-04-29T20:51:15Z&spr=https&sv=2021-12-02&sr=c&sig=lKHKsXgxC0Ec2%2FW4ajx2LlApXnTBG%2FmVxXNHz84RpQw%3D"
...
Copy-VMFile $Win2k19vmName -SourcePath "$agentScript\installArcAgent-mooncake.ps1" -DestinationPath "$Env:ArcBoxDir\installArcAgent-mooncake.ps1" -CreateFullPath -FileSource Host
Copy-VMFile $Win2k22vmName -SourcePath "$agentScript\installArcAgent-mooncake.ps1" -DestinationPath "$Env:ArcBoxDir\installArcAgent-mooncake.ps1" -CreateFullPath -FileSource Host
